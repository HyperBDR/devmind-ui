  ...
  <AppLayout>
    <div class="w-full max-w-full p-6 space-y-6">
      <div class="flex items-center justify-between gap-4">
        <div>
          <h1 class="text-2xl font-semibold text-gray-900">
            {{ t('oneproMonitor.taskDetailPage.title') }}
          </h1>
          <p class="mt-2 text-sm text-gray-500">
            {{ t('oneproMonitor.taskDetailPage.subtitle') }}
          </p>
        </div>
        <router-link
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="text-lg font-semibold text-gray-900">
            {{ t('oneproMonitor.labels.basicInfo') }}
          </h2>
          <dl class="mt-4 space-y-3 text-sm">
            ...
            <div class="flex justify-between gap-4">
              <dt class="text-gray-500">
                {{ t('oneproMonitor.labels.triggerMode') }}
              </dt>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <dl class="mt-4 space-y-3 text-sm">
            <div class="flex justify-between gap-4">
              <dt class="text-gray-500">
                {{ t('oneproMonitor.labels.startTime') }}
              </dt>
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="text-lg font-semibold text-gray-900">
            {{ t('oneproMonitor.labels.collectionResult') }}
          </h2>
          <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="rounded-lg bg-gray-50 border border-gray-200 p-4">
              <p class="text-sm text-gray-500">
                {{ t('oneproMonitor.taskDetailPage.tenantCount') }}
              </p>
            ...
            <div class="rounded-lg bg-gray-50 border border-gray-200 p-4">
              <p class="text-sm text-gray-500">
                {{ t('oneproMonitor.taskDetailPage.licenseCount') }}
              </p>
              <p class="mt-2 text-2xl font-semibold text-gray-900">
            ...
            <div class="rounded-lg bg-gray-50 border border-gray-200 p-4">
              <p class="text-sm text-gray-500">
                {{ t('oneproMonitor.taskDetailPage.hostCount') }}
              </p>
              <p class="mt-2 text-2xl font-semibold text-gray-900">
                {{ task.total_hosts || 0 }}
              </p>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="text-lg font-semibold text-gray-900">
            {{ t('oneproMonitor.labels.errorMessage') }}
          </h2>
          <div
  ...
  try {
    ...
    showError(
      error?.response?.data?.detail ||
        t('oneproMonitor.taskDetailPage.loadError')
    )
  }
}
